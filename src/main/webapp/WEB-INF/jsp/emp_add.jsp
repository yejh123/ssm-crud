            ...
            <div class="modal-body">
                <form class="form-horizontal" id="emp_add_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="empName" id="emp_add_name" placeholder="张三">
...
<script>
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(result.code === "200"){
                        ...
                        show_validate_msg("#emp_add_name","success",result.dataMap.va_msg);
                        $("#emp_add_name").attr("nameIsValid","true");
                    }else {
                        show_validate_msg("#emp_add_name","error",result.dataMap.va_msg);
                        $("#emp_add_name").attr("nameIsValid","false");
                    }
                }
            })
        }
    ...
    function checkNameAvailable() {
        ...
        nameValid();
        var nameIsValid = $("#emp_add_name").attr("nameIsValid");
        if(nameIsValid === "true"){
            return true;
        }else 
            return false;
